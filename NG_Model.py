...
if __name__ == "__main__":
    ...
    helper_methods.print_partition("NG_Method")
    ...
    helper_methods.generate_excel(train_df, preprocess_train_df, model, constants.NG_TRAIN_2, constants.NG_COL)
    helper_methods.generate_excel(test_df, preprocess_test_df, model, constants.NG_TEST_1, constants.NG_COL)
    ...
    model = train_model(preprocess_train_df)
    helper_methods.generate_excel(train_df, preprocess_train_df, model, constants.NG_TRAIN_1, constants.NG_COL)
    helper_methods.generate_excel(test_df, preprocess_test_df, model, constants.NG_TEST_2, constants.NG_COL)
    ...
    model = train_model(preprocess_train_df)
    helper_methods.generate_excel(train_df, preprocess_train_df, model, constants.NG_TRAIN_1_2, constants.NG_COL)
    helper_methods.generate_excel(test_df, preprocess_test_df, model, constants.NG_TEST_3, constants.NG_COL)
